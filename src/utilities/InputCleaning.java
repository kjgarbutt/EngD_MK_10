...
public class InputCleaning {
	 ...
	 * @param attributes
	 *            - optional: include only the given attributes
	 */
	public static synchronized void readInVectorLayer(GeomVectorField layer, String filename, String layerDescription,
			Bag attributes) {
		try {
	 ...
	 * @param type
	 */
	public static synchronized void readInRasterLayer(GeomGridField layer, String filename, String layerDescription,
			GridDataType type) {
		try {
	 ...
	 * 
	 * @param geom
	 *            - the geometry of the object that is impacting the heatmap
	 */
